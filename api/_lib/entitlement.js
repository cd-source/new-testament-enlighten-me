...
function issueServerToken({ productId, userId, source, originalTransactionId, expiresDate }) {
  if (!JWT_SECRET) {
  ...
  return jwt.sign(
    {
      product: productId,
      sub: userId || originalTransactionId || null,
      src: source || null,
      otid: originalTransactionId || null,
      exp,
    },
    JWT_SECRET,
    { algorithm: "HS256" }
